...
export function DashboardView({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ============================================================
          0. 迁移整合的店铺运营与 AI 推荐流量概览 (Storefront & AI Agent Hub)
          ============================================================ */}
      <div className="crextio-card p-4 sm:p-5 bg-white/90 backdrop-blur-xl border border-white/90 shadow-2xs">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 pb-3 border-b border-gray-100">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-xl bg-[#111827] text-[#FB7185] flex items-center justify-center shrink-0 shadow-2xs">
              <Store size={16} />
            </div>
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 rounded-full bg-green-50 text-green-700 text-[10px] font-bold border border-green-200 flex items-center gap-1">
                  <span className="w-1.5 h-1.5 rounded-full bg-green-500 animate-pulse" />
                  <span>{isZh ? '在线中' : 'LIVE'}</span>
                </span>
              </div>
              <p className="text-[11px] text-[#6B7280] mt-0.5">
                {isZh
                  ? '已接入全渠道自适应渲染与 GPT/Claude AI Agent 语义推荐网络'
                  : 'Multi-theme store synced with AI Agent discovery channels.'}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mt-3">
          <div className="p-3 rounded-xl bg-white/90 border border-gray-100 flex items-center justify-between shadow-2xs">
            <div>
              <span className="text-[10px] text-[#6B7280] font-medium block">
                {isZh ? '今日店铺访问 (PV)' : 'Today Pageviews'}
              </span>
              <div className="text-base font-bold text-[#111827] mt-0.5 tnum">2,840</div>
            </div>
            <div className="w-7 h-7 rounded-full bg-[#F3F4F8] flex items-center justify-center text-[#111827]">
              <Globe size={13} />
            </div>
          </div>
          ...
          <div className="p-3 rounded-xl bg-white/90 border border-gray-100 flex items-center justify-between shadow-2xs">
            <div>
              ...
              <div className="text-base font-bold text-[#111827] mt-0.5 tnum">1,120</div>
            </div>
            <div className="w-7 h-7 rounded-full bg-[#F3F4F8] flex items-center justify-center text-[#111827]">
              <Users size={13} />
            </div>
          ...
          <div className="p-3 rounded-xl bg-white/90 border border-gray-100 flex items-center justify-between shadow-2xs">
            <div>
              ...
              <div className="text-base font-bold text-[#111827] mt-0.5 tnum">4.6%</div>
            </div>
            <div className="w-7 h-7 rounded-full bg-white flex items-center justify-center text-[#FB7185] shadow-2xs border border-gray-100">
              <Bot size={13} />
            </div>
          </div>
          ...
          <div className="p-3 rounded-xl bg-white/90 border border-gray-100 flex items-center justify-between shadow-2xs">
            <div>
              ...
              <div className="text-base font-bold text-[#111827] mt-0.5 tnum">4 件</div>
            </div>
            <div className="w-7 h-7 rounded-full bg-[#F3F4F8] flex items-center justify-center text-[#111827]">
              <ShoppingBag size={13} />
            </div>
